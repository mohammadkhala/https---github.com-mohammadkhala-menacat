...
<?php
    $pageTitle = __('editChildren'); //set dynamic page title
?>
@extends($layout)
                ...
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <div class="row gutter-lg ">
                            <div class="col">
                                <!--[form-start]-->
                                <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("children/edit/$rec_id"); ?>" method="post">
                                <!--[form-content-start]-->
                                @csrf
                                <div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div id="ctrl-address-holder" class=" ">
                                                    <input id="ctrl-address" data-field="address"  value="<?php  echo $data['address']; ?>" type="text" placeholder="{{ __('enterAddress') }}"  name="address"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
