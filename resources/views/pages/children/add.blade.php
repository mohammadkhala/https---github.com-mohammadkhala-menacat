...
<?php
    $pageTitle = __('addNewChildren'); //set dynamic page title
?>
@extends($layout)
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="children-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('children.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-name-holder" class=" ">
                                                <input id="ctrl-name" data-field="name"  value="<?php echo get_value('name', "NULL") ?>" type="text" placeholder="{{ __('enterName') }}"  name="name"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="date_of_birth">{{ __('dateOfBirth') }} </label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div id="ctrl-date_of_birth-holder" class="input-group ">
                                                <input id="ctrl-date_of_birth" data-field="date_of_birth" class="form-control datepicker  datepicker"  value="<?php echo get_value('date_of_birth', "NULL") ?>" type="datetime" name="date_of_birth" placeholder="{{ __('enterDateOfBirth') }}" data-enable-time="false" data-min-date="" data-max-date="" data-date-format="Y-m-d" data-alt-format="F j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-address-holder" class=" ">
                                                <input id="ctrl-address" data-field="address"  value="<?php echo get_value('address', "NULL") ?>" type="text" placeholder="{{ __('enterAddress') }}"  name="address"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-class-holder" class=" ">
                                                <input id="ctrl-class" data-field="class"  value="<?php echo get_value('class', "NULL") ?>" type="text" placeholder="{{ __('enterClass') }}"  name="class"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
