...
<?php
    $pageTitle = __('addNewMedicalStatus'); //set dynamic page title
?>
@extends($layout)
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="medical_status-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('medical_status.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-children_id-holder" class=" ">
                                                <input id="ctrl-children_id" data-field="children_id"  value="<?php echo get_value('children_id', "NULL") ?>" type="text" placeholder="{{ __('enterChildrenId') }}"  name="children_id"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-remaining-holder" class=" ">
                                                <input id="ctrl-remaining" data-field="remaining"  value="<?php echo get_value('remaining', "NULL") ?>" type="number" placeholder="{{ __('enterRemaining') }}" step="0.1"  name="remaining"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
