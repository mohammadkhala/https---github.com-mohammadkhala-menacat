...
<?php
    $pageTitle = __('editMaritalStatus'); //set dynamic page title
?>
@extends($layout)
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("marital_status/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-cost-holder" class=" ">
                                            <input id="ctrl-cost" data-field="cost"  value="<?php  echo $data['cost']; ?>" type="text" placeholder="{{ __('enterCost') }}"  name="cost"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-children_id-holder" class=" ">
                                            <input id="ctrl-children_id" data-field="children_id"  value="<?php  echo $data['children_id']; ?>" type="number" placeholder="{{ __('enterChildrenId') }}" step="any"  name="children_id"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
