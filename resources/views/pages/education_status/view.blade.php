...
<?php
    $pageTitle = __('educationStatusDetails'); //set dynamic page title
?>
@extends($layout)
                        ...
                        <div id="page-main-content" class=" px-3 mb-3">
                            ...
                            <div class="page-data">
                                ...
                                <div class="d-flex gap-1 justify-content-start">
                                    <a class="btn btn-sm btn-success has-tooltip "   title="{{ __('edit') }}" href="<?php print_link("education_status/edit/$rec_id"); ?>" >
                                    <i class="material-icons">edit</i> {{ __('edit') }}
                                </a>
                                <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="{{ __('promptDeleteRecord') }}" data-display-style="modal" title="{{ __('delete') }}" href="<?php print_link("education_status/delete/$rec_id?redirect=education_status"); ?>" >
