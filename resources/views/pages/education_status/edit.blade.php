...
<?php
    $pageTitle = __('editEducationStatus'); //set dynamic page title
?>
@extends($layout)
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("education_status/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-diagnosis-holder" class=" ">
                                            <input id="ctrl-diagnosis" data-field="diagnosis"  value="<?php  echo $data['diagnosis']; ?>" type="text" placeholder="{{ __('enterDiagnosis') }}"  name="diagnosis"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-children_id-holder" class=" ">
                                            <input id="ctrl-children_id" data-field="children_id"  value="<?php  echo $data['children_id']; ?>" type="text" placeholder="{{ __('enterChildrenId') }}"  readonly name="children_id"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-remaining-holder" class=" ">
                                            <input id="ctrl-remaining" data-field="remaining"  value="<?php  echo $data['remaining']; ?>" type="number" placeholder="{{ __('enterRemaining') }}" step="any"  name="remaining"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
