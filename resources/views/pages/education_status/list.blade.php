...
<?php
    ...
    $pageTitle = __('educationStatus'); //set dynamic page title
?>
@extends($layout)
        ...
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-md-auto  " >
                    <a  class="btn btn-primary" href="<?php print_link("education_status/add", true) ?>" >
                    <i class="material-icons">add</i>                               
                    {{ __('addNewEducationStatus') }} 
                </a>
            </div>
            <div class="col-md-3  " >
        ...
        <div class="row ">
            <div class="col-md-12 comp-grid " >
                ...
                <div  class=" page-content" >
                    <div id="education_status-list-records">
                        <div id="page-main-content" class="table-responsive">
                            <?php Html::page_bread_crumb("/education_status/", $field_name, $field_value); ?>
                            <table class="table table-hover table-striped table-sm text-left">
                                <thead class="table-header ">
                                    <tr>
                                        ...
                                        <th class="td-remaining" > {{ __('remaining') }}</th>
                                        <th class="td-date" > {{ __('date') }}</th>
                                        <th class="td-btn"></th>
                                    </tr>
                                </thead>
                                <?php
                                ...
                                <tbody class="page-data">
                                    ...
                                    <?php
                                        ...
                                        $sum_of_remaining = $sum_of_remaining + $data['remaining'];
                                    ?>
                                    <tr>
                                        ...
                                        <!--PageComponentStart-->
                                        <td class="td-id">
                                            <a href="<?php print_link("education_status/view/$data[id]") ?>"><?php echo $data['id']; ?></a>
                                        </td>
                                        <td class="td-diagnosis">
                                            <span  data-source='<?php print_link('componentsdata/class_option_list'); ?>' 
                                            data-value="<?php echo $data['diagnosis']; ?>" 
                                            data-pk="<?php echo $data['id'] ?>" 
                                            data-url="<?php print_link("education_status/edit/" . urlencode($data['id'])); ?>" 
                                            data-name="diagnosis" 
                                        ...
                                        <td class="td-remaining">
                                            <span  data-step="any" 
                                            data-source='<?php print_link('componentsdata/class_option_list'); ?>' 
                                            data-value="<?php echo $data['remaining']; ?>" 
                                            data-pk="<?php echo $data['id'] ?>" 
                                            data-url="<?php print_link("education_status/edit/" . urlencode($data['id'])); ?>" 
                                            data-name="remaining" 
                                            data-title="Enter Remaining" 
                                            data-placement="left" 
                                            data-toggle="click" 
                                            data-type="number" 
                                            data-mode="popover" 
                                        ...
                                        <td class="td-btn">
                                            <div class="dropdown" >
                                                ...
                                                <ul class="dropdown-menu">
                                                    <a class="dropdown-item "   href="<?php print_link("education_status/view/$rec_id"); ?>" >
                                                    <i class="material-icons">visibility</i> {{ __('view') }}
                                                </a>
                                                <a class="dropdown-item "   href="<?php print_link("education_status/edit/$rec_id"); ?>" >
                                                <i class="material-icons">edit</i> {{ __('edit') }}
                                            </a>
                                            <a class="dropdown-item record-delete-btn" data-prompt-msg="{{ __('promptDeleteRecord') }}" data-display-style="modal" href="<?php print_link("education_status/delete/$rec_id"); ?>" >
                    ...
                    <tfoot><tr><th></th><th></th><th></th><th>Total Cost = <?php echo $sum_of_cost;  ?></th><th></th><th>Total Remaining = <?php echo $sum_of_remaining;  ?></th><th></th><th></th></tr></tfoot>
                    <?php
                        }
                        else{
                    ?>
                ...
                <div class="row align-items-center justify-content-between">    
                    <div class="col-md-auto justify-content-center">    
                        <div class="d-flex justify-content-start">  
                            <button data-prompt-msg="{{ __('promptDeleteRecords') }}" data-display-style="modal" data-url="<?php print_link("education_status/delete/{sel_ids}"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
