...
/* routes for Education_Status Controller */	
	Route::get('education_status', 'Education_StatusController@index')->name('education_status.index');
	Route::get('education_status/index', 'Education_StatusController@index')->name('education_status.index');
	Route::get('education_status/index/{filter?}/{filtervalue?}', 'Education_StatusController@index')->name('education_status.index');	
	Route::get('education_status/view/{rec_id}', 'Education_StatusController@view')->name('education_status.view');	
	Route::get('education_status/add', 'Education_StatusController@add')->name('education_status.add');
	Route::post('education_status/add', 'Education_StatusController@store')->name('education_status.store');
		
	Route::any('education_status/edit/{rec_id}', 'Education_StatusController@edit')->name('education_status.edit');Route::any('education_status/editfield/{rec_id}', 'Education_StatusController@editfield');	
	Route::get('education_status/delete/{rec_id}', 'Education_StatusController@delete');
...
Route::get('componentsdata/class_option_list',  function(Request $request){
		$compModel = new App\Models\ComponentsData();
		return $compModel->class_option_list($request);
	}
)->middleware(['auth']);
