...
class ChildrenController extends Controller
{
	...
	function index(Request $request, $fieldname = null , $fieldvalue = null){
		...
		$query->leftJoin("marital_status", "children.id", "=", "marital_status.children_id");
		$query->leftJoin("medical_status", "children.id", "=", "medical_status.children_id");
		$query->leftJoin("education_status", "children.id", "=", "education_status.children_id");
